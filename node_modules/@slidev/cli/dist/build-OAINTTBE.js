...
async function build(options, viteConfig = {}, args) {
  ...
  await _fsextra2.default.writeFile(indexPath, await _chunkZVE3I55Ejs.getIndexHtml.call(void 0, options), "utf-8");
  let config = void 0;
  try {
    const inlineConfig = await _chunkZVE3I55Ejs.mergeViteConfigs.call(void 0, 
      options,
      viteConfig,
      {
        root: options.userRoot,
        plugins: [
          await _chunkZVE3I55Ejs.ViteSlidevPlugin.call(void 0, options, pluginOptions),
          {
            name: "resolve-config",

...
var _chunkZVE3I55Ejs = require('./chunk-ZVE3I55E.js');
...
var require_iterator = _chunkGE7W2DBEjs.__commonJS.call(void 0, {
...
var require_yallist = _chunkGE7W2DBEjs.__commonJS.call(void 0, {
...
var require_lru_cache = _chunkGE7W2DBEjs.__commonJS.call(void 0, {
...
async function createServer(options, viteConfig = {}, serverOptions = {}) {
  ...
  const server = await _vite.createServer.call(void 0, 
    await _chunkZVE3I55Ejs.mergeViteConfigs.call(void 0, 
      options,
      viteConfig,
      {
        optimizeDeps: {
        ...
        plugins: [
          await _chunkZVE3I55Ejs.ViteSlidevPlugin.call(void 0, options, pluginOptions, serverOptions)
        ]
      },
      "serve"
    )
...
var Queue = class {
  constructor() {
    _chunkGE7W2DBEjs.__privateAdd.call(void 0, this, _head, void 0);
    _chunkGE7W2DBEjs.__privateAdd.call(void 0, this, _tail, void 0);
    _chunkGE7W2DBEjs.__privateAdd.call(void 0, this, _size, void 0);
    this.clear();
  }
  enqueue(value) {
    const node = new Node(value);
    if (_chunkGE7W2DBEjs.__privateGet.call(void 0, this, _head)) {
      _chunkGE7W2DBEjs.__privateGet.call(void 0, this, _tail).next = node;
      _chunkGE7W2DBEjs.__privateSet.call(void 0, this, _tail, node);
    } else {
      _chunkGE7W2DBEjs.__privateSet.call(void 0, this, _head, node);
      _chunkGE7W2DBEjs.__privateSet.call(void 0, this, _tail, node);
    }
    _chunkGE7W2DBEjs.__privateWrapper.call(void 0, this, _size)._++;
  }
  dequeue() {
    const current = _chunkGE7W2DBEjs.__privateGet.call(void 0, this, _head);
    if (!current) {
      return;
    }
    _chunkGE7W2DBEjs.__privateSet.call(void 0, this, _head, _chunkGE7W2DBEjs.__privateGet.call(void 0, this, _head).next);
    _chunkGE7W2DBEjs.__privateWrapper.call(void 0, this, _size)._--;
    return current.value;
  }
  clear() {
    _chunkGE7W2DBEjs.__privateSet.call(void 0, this, _head, void 0);
    _chunkGE7W2DBEjs.__privateSet.call(void 0, this, _tail, void 0);
    _chunkGE7W2DBEjs.__privateSet.call(void 0, this, _size, 0);
  }
  get size() {
    return _chunkGE7W2DBEjs.__privateGet.call(void 0, this, _size);
  }
  *[Symbol.iterator]() {
    let current = _chunkGE7W2DBEjs.__privateGet.call(void 0, this, _head);
    while (current) {
      yield current.value;
...
// node/themes.ts
var import_semver2 = _chunkGE7W2DBEjs.__toESM.call(void 0, require_semver2());
...
// node/addons.ts
var import_semver = _chunkGE7W2DBEjs.__toESM.call(void 0, require_semver2());

async function getPackageJson(root) {
  try {
    const file = _chunkGE7W2DBEjs.resolveImportPath.call(void 0, `${root}/package.json`, true);
...
function resolvePluginName(name) {
  ...
  if (isPath(name))
    return name;
  if (_chunkGE7W2DBEjs.packageExists.call(void 0, `slidev-addon-${name}`))
...
function getClientRoot() {
  return _path.dirname.call(void 0, _chunkGE7W2DBEjs.resolveImportPath.call(void 0, "@slidev/client/package.json", true));
}
function getCLIRoot() {
...
function getRoot(name, entry) {
  ...
  return _path.dirname.call(void 0, _chunkGE7W2DBEjs.resolveImportPath.call(void 0, `${name}/package.json`, true));
}
...
async function resolveOptions(options, mode2, promptForInstallation = true) {
  ...
  if (promptForInstallation) {
    ...
    if (!_chunkGE7W2DBEjs.packageExists.call(void 0, theme)) {
...
function resolveThemeName(name) {
  ...
  if (isPath(name))
    return name;
  if (_chunkGE7W2DBEjs.packageExists.call(void 0, `@slidev/theme-${name}`))
    return `@slidev/theme-${name}`;
  if (_chunkGE7W2DBEjs.packageExists.call(void 0, `slidev-theme-${name}`))
    return `slidev-theme-${name}`;
  if (_chunkGE7W2DBEjs.packageExists.call(void 0, name))
    return name;
...
async function promptForThemeInstallation(name) {
  ...
  if (!name)
    return name;
  if (isPath(name) || _chunkGE7W2DBEjs.packageExists.call(void 0, name))
    return name;
